...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (cb) {
    return promise.then(function(args) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (R.isArrayLike(args) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!options.no_spread)</span> {
